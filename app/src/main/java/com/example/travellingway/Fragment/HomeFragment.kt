...
import com.example.travellingway.Activity.DisplayplaceActivity
import com.example.travellingway.Adapter.AdapterClass
import com.example.travellingway.Adapter.ImageAdapter
import com.example.travellingway.ModelClass.StudentModelClass
import com.example.travellingway.R
import com.example.travellingway.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
        ...
        refrence.root.child("AdminTb").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                var adpter = AdapterClass(this@HomeFragment, list, onItemClick = {
                    ...
                    var i = Intent(context,DisplayplaceActivity::class.java)
    ...
    private fun initview() {
        ...
        Binding?.imgLack?.setOnClickListener {
        ...
        Binding?.imgDesert?.setOnClickListener {
